    ...
    <style type="text/css">
        * {
        ...
        .pagination-container {
            ...
            z-index: 9999;
            /* Set the z-index to ensure it appears above other content */
        }
    </style>
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <main class="main_table">
                        <section class="table__header">
                            <h1 class="title_deg">All Transaction</h1>
